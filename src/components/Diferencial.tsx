    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <Reveal>
            <p
              className="uppercase tracking-[0.3em] font-light mb-5"
            ...
            <h2
              ...
              style={{ fontSize: 'clamp(1.7rem, 3.6vw, 2.6rem)', letterSpacing: '0.02em' }}
            >
              O que esperar
              <br />
            ...
            <p
              className="font-light leading-relaxed mt-6 max-w-md"
              style={{ color: 'var(--text-2)', fontSize: '0.92rem' }}
            >
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div>
                    <h3
                      ...
                      style={{ fontSize: '0.74rem', color: '#FFFFFF' }}
                    >
                      {item.title}
                    </h3>
                    <p
                      className="font-light leading-relaxed"
                      style={{ color: 'var(--text-2)', fontSize: '0.84rem' }}
                    >
                      {item.desc}
                    </p>
                  </div>
