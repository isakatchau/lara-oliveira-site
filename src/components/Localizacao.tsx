    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2">
          ...
          <div
            className="flex flex-col justify-center gap-8 px-8 lg:px-16 py-20"
            ...
            <Reveal delay={140}>
              <div className="flex flex-col gap-2">
                ...
                <p className="font-light pt-2" style={{ color: 'var(--text-3)', fontSize: '0.78rem' }}>
                  Atendimento com hora marcada · seg–sex, 9h–18h
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={200}>
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex items-center justify-center uppercase tracking-widest font-semibold text-xs px-6 py-3 cta-gold"
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 uppercase tracking-widest font-semibold text-xs px-6 py-3"
          ...
          <Reveal delay={120} className="relative overflow-hidden" style={{ minHeight: '420px' }}>
            <iframe
      ...
      >
        <div
          ...
          style={{
            backgroundImage: 'url(/images/lara-footer-bg.svg)',
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 flex flex-col items-center gap-5">
          ...
          <Reveal delay={80}>
            <h2
              ...
              style={{ fontSize: 'clamp(1.4rem, 3vw, 2.1rem)', letterSpacing: '0.04em', lineHeight: 1.25 }}
            >
              Tem uma queixa específica?
              <br />
              <span style={{ color: 'var(--gold)' }}>Me conta no WhatsApp.</span>
            </h2>
          </Reveal>
          <Reveal delay={140}>
            <p
            ...
            >
              Quem responde sou eu — não assistente. Pode mandar foto da queixa, eu te oriento se faz sentido marcar consulta.
            </p>
          </Reveal>
          <Reveal delay={200}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 font-semibold uppercase tracking-widest text-xs px-9 py-4 cta-glow mt-2"
          ...
          <Reveal delay={260}>
            <p style={{ color: 'var(--text-3)', fontSize: '0.7rem' }}>
              WhatsApp · Seg–sex, 9h–18h · Resposta no mesmo dia
            </p>
          </Reveal>
        </div>
      </div>
